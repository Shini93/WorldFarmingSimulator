...
final String[] buldNames = {"Hauptgebaude", "Rohstofflager", "Kornspeicher", "Kaserne", "Stall", "Schmiede", "Akademie","Versammlungsplatz","Turnierplatz","Werkstatt","Marktplatz","Handelskontor",
                            "Baeckerei","Eisengießerei","Getreidemuehle","Lehmbrennerei","Saegewerk","Residenz","Palast","Rathaus","Pferdetraenke","Hospital"};
...
final static int ressourceTextSize = 28;
final static int buildingTextSize = 16;
final static int normalTextSize = 20;
final static int titleTextSize = 30;

Byte operatingSystem = windows;

color[] colorPalette = {#00AA00,100,#FF0000};
...
void initInterface() {
  ...
  btn_toggleMap = new Button(10,300, "Map");
